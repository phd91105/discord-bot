...
export function filterCommit(listIssue, { data }) {
...
export function createEmbed(title, commit, color) {
    const listMsg = _.map(commit, (item) => `[2;36m${item.message.match(/#\d+/)[0].trim()}[0m ` +
